...
namespace BookLibAPI.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] UserLogin userLogin)
        {
            ...
            if (user != null)
            {
                var token = Generate(user);//it will contain all the user details. It will be created from the usermodel class.
                return Ok(token);
            }
        ...
        private User Authenticate(UserLogin userLogin)
        {
            ...
            //not a proper authentication so you shouldn't use it in your application
            if (currentUser != null)
            {
                return currentUser;
            }
